 ...
 * @link https://github.com/neo4j/neo4j-javascript-driver/issues/1140
 **/
program.command("neo4j")
	.description("CLI for Neo4j")
	.option('-f, --file [items...]', 'CSV file to parse, where [file] [bucketName]')
